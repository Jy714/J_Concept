    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        <div className='text-xl sm:text-2xl my-3'>
          <Title header={"DELIVERY"} desc={"INFORMATION"} />
        </div>
        ...
        <div className='flex gap-3'>
          ...
          <input required name='country' value={formData.country} type="text" placeholder='Country' disabled className='border border-gray-300 rounded py-1.5 px-3.5 w-full' />
        </div>
        <div className='flex items-center'>
          <span className='mr-2'><b>+60</b></span>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          <Title header={"PAYMENT"} desc={"METHOD"} />
